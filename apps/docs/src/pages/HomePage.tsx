...
export const HomePage = () => {
  return (
    <div className="text-white">
      <div className="pb-4 ">
        <h1 className="text-5xl pb-5  font-medium">Design System </h1>
        <p className="text-sm/7   font-normal mt-2 w-full md:w-[65%]  ">
          Una biblioteca de componentes en React está diseñada para garantizar
          la consistencia visual y técnica en todos nuestros productos. Aquí
          encontrarás una colección curada de componentes reutilizables,
        ...
        <p className="flex gap-5 py-5 mt-4">
          ...
          <Link
            to="/componente/botones"
            className="border-2 border-white  py-3 px-5 rounded-3xl cursor-pointer transition-all duration-400 hover:bg-white hover:border-blue-950 hover:text-blue-950 hover:pr-7"
          >
            Ver componentes
          </Link>
        </p>
      ...
      <div className="relative pt-5 mb-8">
        <Link to="/documentacion/instalacion">
          <img
            src={BackHome}
            alt="Componentes"
        ...
        <div className="pointer-events-none absolute inset-0 rounded-xl bg-blue-900/10 mix-blend-multiply"></div>
      </div>

      <hr className="text-blue-900 my-5" />

      <div className="flex xs:flex-col my-20">
        <h2 className="text-4xl/10 md:w-[40%] pr-12 ">
          Desarrollar interfaces de usuario duraderas{" "}
        </h2>
        <div className="mx-4 md:w-[60%] pl-10">
          <p className="text-base pb-4">
            Puedes crear interfaces de usuario de forma sensilla con los Tokens
            y Ui Components. Esta desarrollado de forma eficiente para que
            puedas integrar en tu plataforma o lenguaje de{" "}
          </p>

          <b>Hecho para:</b>
          <div className="flex items-center gap-4 pt-2">
            <a
              className="flex h-10 w-10 items-center justify-center rounded-3xl border border-blue-400 transition-all  hover:border-blue-200"
              title="React"
            >
              <svg
                height="24"
            ...
            >
              ...
              >
                <g id="_x2F_logo_x2F_angular">
                  <polygon
                    id="Fill-1"
                    points="48.5 1.3 5.2 16.8 11.8 74.3 48.5 94.7 85.2 74.3 91.8 16.8"
                    fill="#dd0031"
                  ></polygon>
                  <polygon
                    id="Fill-2"
                    points="48.5 1.3 49 11.7 49 11.7 49 58.9 48.5 94.7 85.3 74.3 91.8 16.8"
                    fill="#c3002f"
                  ></polygon>
                  <path
                    d="M57,51.1H41.1l8-19.2L57,51.1z M49.1,12L21.8,73.3H32l5.5-13.7h23.1l5.5,13.7h10.2 L49.1,12z"
                    id="Fill-3"
                    fill="#fff"
                  ></path>
                </g>
      ...
      <div className="flex xs:flex-col my-20">
        <div className="flex w-full flex-col gap-6 md:flex-row md:items-start">
          ...
          <Link
            to="/componente/botones">
            <div className="aspect-square w-full rounded-xl bg-[url('/src/assets/banner_home.jpg')] bg-cover bg-right bg-no-repeat "></div>
            </Link>
          </div>

          <div className="flex w-full flex-col gap-4 md:w-1/2">
            <div className="flex gap-4 rounded-xl border border-[#1e2a44] bg-[#0f1228] px-4 py-4 shadow-sm transition-all hover:ring-2 hover:ring-blue-600/60">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#0f3a4e] text-xl">
                🟦
              </div>
              <div className="text-left">
                <p className="text-lg font-semibold text-white">
                  Prueba visual de apariencia
                </p>
                <p className="text-sm text-zinc-300">
                  Detecta cambios en la interfaz al nivel del píxel.
                </p>
              </div>
            </div>

            <div className="flex gap-4 rounded-xl border border-[#1e2a44] bg-[#0f1228] px-4 py-4 shadow-sm transition-all hover:ring-2 hover:ring-blue-600/60">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#0f2c48] text-xl">
                🖱️
              </div>
              <div className="text-left">
                <p className="text-lg font-semibold text-white">
                ...
                <p className="text-sm text-zinc-300">
                  Simula el comportamiento del usuario y verifica en el
                  navegador.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 rounded-xl border border-[#1e2a44] bg-[#0f1228] px-4 py-4 shadow-sm transition-all hover:ring-2 hover:ring-blue-600/60">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#2f1a4a] text-xl">
                ♿
              </div>
              <div className="text-left">
                <p className="text-lg font-semibold text-white">
                ...
                <p className="text-sm text-zinc-300">
                  Revisa historias para detectar problemas WCAG y ARIA.
                </p>
              </div>
            </div>

            <div className="flex gap-4 rounded-xl border border-[#1e2a44] bg-[#0f1228] px-4 py-4 shadow-sm transition-all hover:ring-2 hover:ring-blue-600/60">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#2b1f0f] text-xl">
                📊
              </div>
              <div className="text-left">
                <p className="text-lg font-semibold text-white">
                ...
                <p className="text-sm text-zinc-300">
                  Mide qué tanto de tu código frontend está cubierto por
                  pruebas.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 rounded-xl border border-[#1e2a44] bg-[#0f1228] px-4 py-4 shadow-sm transition-all hover:ring-2 hover:ring-blue-600/60">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1b2e3b] text-xl">
                🧾
              </div>
              <div className="text-left">
                <p className="text-lg font-semibold text-white">
                  Snapshot del marcado
                </p>
                <p className="text-sm text-zinc-300">
                  Detecta regresiones en el marcado del DOM.
                </p>
              </div>
            </div>
          </div>
