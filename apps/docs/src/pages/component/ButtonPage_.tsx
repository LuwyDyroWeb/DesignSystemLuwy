...
${Array.from({ length: groupCount })
  ...
  const getStyleButtonClasses = (
    ...
    const base = "px-6 py-4 border-primary-blue-600 cursor-pointer";
    ...
    <>
      ...
      <section className="grid grid-cols-1 xl:grid-cols-[2.1fr_1fr] xl:grid-rows-1 grid-row-2 mt-6 gap-6 ">
        <div className="flex flex-col">
          ...
          <div className="border-2 border-t-0  rounded-b-medium p-6 border-primary-blue-600">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex border-2 border-t-0 rounded-b-medium p-6 border-primary-blue-600 h-full">
