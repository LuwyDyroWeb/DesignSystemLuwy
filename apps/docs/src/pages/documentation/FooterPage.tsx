  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-4">
        <div className="flex h-200 w-60 flex-col gap-2 rounded-2xl border-dashed border-2 border-zinc-500/50 p-2">
          Sidebar
      ...
      <div className="flex animate-pulse w-full rounded-2xl py-3 border-2 border-dashed border-zinc-500/50 p-2">
        Footer
      </div>
